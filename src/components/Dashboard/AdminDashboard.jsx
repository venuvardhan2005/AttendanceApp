...
export function AdminDashboard({ user }) {
  ...
  const departmentData = [
    { name: 'CompSci', students: 450, attendance: 88 },
    { name: 'Math', students: 320, attendance: 85 },
    { name: 'Physics', students: 280, attendance: 82 },
    { name: 'Chem', students: 200, attendance: 90 },
  ];
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{stats.lowAttendanceStudents}</p>
            </div>
          </div>
        </div>
      </div>
